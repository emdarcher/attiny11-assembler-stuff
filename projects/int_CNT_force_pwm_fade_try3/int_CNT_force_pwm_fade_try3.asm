...
PWM_INC:
    ...
    sbrc status_regA,PWM_flag_bit;
        rcall TOGGLE_PWM_STATUS;
    ;DEC PWM_INC_VAL;
...
TOGGLE_PWM_STATUS:
    ...
    cbr status_regA, (1<<PWM_flag_bit);
    RET;

do_a_ret_thingy:
    RET;

;do_a_ret_thingy_and_fix:
...
put_pwm_up:
    ...
    inc PWM_INC_VAL;
        BRNE STORE_PWM; 
    clr pwm_val_store
    ldi pwm_val_store,0xFF;
    tgl_tfr_reg status_regA,PWM_flag_bit;
